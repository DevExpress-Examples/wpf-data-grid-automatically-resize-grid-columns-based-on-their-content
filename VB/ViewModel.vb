...
Namespace E2042
    ...
    Public Class DelegateCommand
        ...
        Public Sub New(ByVal executeMethod As Action)
            Me._ExecuteDelegate = DirectCast(System.Delegate.Combine(Me._ExecuteDelegate, executeMethod), Action)
        End Sub

        Protected _ExecuteDelegate As Action
        ...
        Public Sub Execute(ByVal parameter As Object) Implements ICommand.Execute
            If Me._ExecuteDelegate IsNot Nothing Then
                Me._ExecuteDelegate()
            End If
        End Sub
    End Class
